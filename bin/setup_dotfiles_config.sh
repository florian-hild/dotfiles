...
if ! grep -wq 'dotfiles/\.bash_profile' ~/.bash_profile; then
echo "Add to ${HOME}/.bash_profile"
cat >> ${HOME}/.bash_profile <<EOF

# Load bash_profile from dotfiles
if [[ -f ${DOT_PATH}/.bash_profile ]]; then
  . ${DOT_PATH}/.bash_profile
fi
